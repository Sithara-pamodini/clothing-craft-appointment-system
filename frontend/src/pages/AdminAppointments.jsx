...
import { Pencil, Trash2, Plus, CalendarDays, Phone, Mail, CreditCard, RefreshCcw, User, Eye, X, Clock, FileText, Shirt, CheckCircle } from "lucide-react";
...
function AdminAppointments() {
  ...
  const handleConfirmAppointment = async (appointment) => {
    if (!confirm(`Confirm appointment for ${appointment.customer_name}?`)) {
      return;
    }
    ...
    try {
      ...
      alert("Appointment confirmed successfully. Confirmation email sent to customer.");
      loadAppointments();
    } catch (error) {
      console.error(error);
                  ...
                  <div className="p-5 space-y-4">
                    <div className="grid grid-cols-1 gap-3">
                      <div className="flex items-start gap-3 bg-[#fffaf7] border rounded-2xl p-4">
                        <Phone size={18} className="text-pink-700 mt-0.5" />
                        <div>
                      ...
                      {appointment.status !== "confirmed" &&
                        ...
                        appointment.status !== "cancelled" && (
                          <button
                            ...
                            className="inline-flex items-center justify-center w-11 h-11 bg-green-600 text-white rounded-full hover:bg-green-700 transition"
                          >
                            <CheckCircle size={18} />
                          </button>
                        )}
                      ...
                      >
                        ...
                        <td className="px-5 py-5 align-middle">
                          <div className="flex items-center gap-2 text-sm">
                            <Phone size={15} className="text-pink-700" />
                            ...
                            {appointment.status !== "confirmed" &&
                              ...
                              appointment.status !== "cancelled" && (
                                <button
                                  ...
                                  title="Confirm Appointment"
                                  aria-label="Confirm Appointment"
                                  className="inline-flex items-center justify-center w-10 h-10 bg-green-600 text-white rounded-full hover:bg-green-700 transition"
                                >
                                  <CheckCircle size={17} />
                                </button>
                              )}
        ...
        <div className="sticky top-0 bg-white border-b px-6 py-5 rounded-t-3xl flex items-start justify-between gap-4">
          <div>
            ...
            <p className="text-gray-500 mt-1">
              Full booking information for this customer appointment.
            </p>
          </div>
        ...
        <div className="p-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            ...
            <DetailBox
              icon={<Phone size={19} />}
              label="Phone"
              value={appointment.customer_phone || "N/A"}
            />

            <DetailBox
              icon={<Mail size={19} />}
              label="Email"
              value={appointment.customer_email || "No email"}
            />
